...
public class ListData {
    ...
    public static void main(String[] args) {
        ...
        hashSet.add("Armut");
        hashSet.add("Muz");
        hashSet.add("Elma"); // Aynı eleman eklenmez!
        System.out.println("HashSet: " + hashSet); // Çıktı: [Muz, Elma, Armut] (Sıra karışık olabilir)

        Set<String> treeSet = new TreeSet<>(hashSet);
        System.out.println("TreeSet: " + treeSet); // Çıktı: [Armut, Elma, Muz] (Sıralı)

        Set<String> linkedHashSet = new LinkedHashSet<>(hashSet);
        System.out.println("LinkedHashSet: " + linkedHashSet); // Çıktı: [Muz, Elma, Armut] (Eklenme sırası korunur)
    }
}